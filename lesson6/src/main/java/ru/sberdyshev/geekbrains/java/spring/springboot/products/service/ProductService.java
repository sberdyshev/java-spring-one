package ru.sberdyshev.geekbrains.java.spring.springboot.products.service;
...
import ru.sberdyshev.geekbrains.java.spring.springboot.products.exception.NotFoundProductException;
import ru.sberdyshev.geekbrains.java.spring.springboot.products.exception.NotValidProductException;
import ru.sberdyshev.geekbrains.java.spring.springboot.products.repository.ProductRepository;
...
public class ProductService {
    ...
    public Optional<Product> update(Product product) {
        ...
        if (optionalProduct != null && optionalProduct.isPresent()) {
            ...
            logger.error("Called \"{}\". Product with id \"{}\" wasn't found, throwing NotFoundProductException exception",
                    updateByProductOperation,
                    product.getId());
    ...
    public Optional<Product> delete(Optional<Long> productId) {
        ...
        if (productId == null || !productId.isPresent()) {
            logger.error("Called \"{}\". ID is null, throwing NotValidProductException exception",
                    deleteByIdOperation);
            throw new NotValidProductException(NotValidCodes.NOT_VALID_OBJECT_IS_NULL,
